...
module.exports = function(moduleConfig) {
    ...
    var result = {
        ...
        start: function() {
            cachePath = path.resolve((this.config.packer && this.config.packer.cachePath) || path.join(bus.config.workDir, 'ut-front', this.config.id));
            ...
            if (this.config.packer && this.config.packer.name === 'webpack') {
                ...
                var wb = require('./webpack/ut-front.config')({
                    ...
                    translate: this.config.packer.translate || bus.importMethod('core.translation.fetch'),
